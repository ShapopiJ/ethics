...
new GPEP_Edit_Entry( array(
	'form_id'        => 4,   // Set this to the form ID.
	'delete_partial' => true, // Set this to false if you wish to preserve partial entries after an edit is submitted.
) );
new GPEP_Edit_Entry( array(
	'form_id'        => 5,   // Set this to the form ID.
	'delete_partial' => true, // Set this to false if you wish to preserve partial entries after an edit is submitted.
) );
